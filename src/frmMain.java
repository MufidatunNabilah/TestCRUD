...
public class frmMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Nama Orang Tua");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(Ortu, javax.swing.GroupLayout.DEFAULT_SIZE, 249, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(Ortu, javax.swing.GroupLayout.DEFAULT_SIZE, 34, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel6)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        jPanel2.setBounds(10, 160, 290, 540);
        ...
        jPanel4.setBounds(310, 110, 790, 40);
        ...
        Tabeldata.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIS", "Nama", "Nama Orang Tua", "Jenis Kelamin", "Kelas", "No. HP", "Email", "Alamat"
            }
        ) {
        ...
        jPanel5.setBounds(310, 160, 790, 540);

        setSize(new java.awt.Dimension(1124, 748));
    ...
    private void SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveActionPerformed
        ...
        if("".equals(NIS.getText()) || "".equals(Nama.getText()) ||               
                "".equals(Ortu.getText()) || "".equals(Kelas.getText()) ||
                "".equals(HP.getText()) || "".equals(Email.getText()) || "".equals(Alamat.getText())){
            ...
            String SQL = "INSERT INTO t_siswa (NIS, NamaSiswa, NamaOrangTua, JenisKelamin, Kelas, NoHp, Email, Alamat)"
                        + "VALUES('"+NIS.getText()+"','"+Nama.getText()+"','"+Ortu.getText()+"','"+JK+"','"+Kelas.getText()+"','"+HP.getText()+"','"+Email.getText()+"','"+Alamat.getText()+"')";
    ...
    private void EditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditActionPerformed
        // TODO add your handling code here:
          if("".equals(NIS.getText()) || "".equals(Nama.getText()) ||               
            ...
            String SQL = "UPDATE `t_siswa` SET `NIS`='"+NIS.getText()+"',`NamaSiswa`='"+Nama.getText()+"',`NamaOrangTua`='"+Ortu.getText()+"',`JenisKelamin`='"+JK+"',`Kelas`='"+Kelas.getText()+"',`NoHp`='"+HP.getText()+"',`Email`='"+Email.getText()+"',`Alamat`='"+Alamat.getText()+"','"+"WHERE NIS='"+NIS.getText();
            int status = KoneksiDB.execute(SQL);
            if (status == 0){
    ...
    public void selectData() {
        String kolom[] = {"NIS", "NamaSiswa","NamaOrangTua", "JenisKelamin", "Kelas", "NoHp", "Email", "Alamat"};
        ...
        try {
            while(rs.next()) {
                ...
                String NamaOrangTua = rs.getString(3);
                String JenisKelamin = "";
                ...
                String data[] = {NIS,NamaSiswa,NamaOrangTua,JenisKelamin,Kelas,NoHp,Email,Alamat};
                dtm.addRow(data);
            }
